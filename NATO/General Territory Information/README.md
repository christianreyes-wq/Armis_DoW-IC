## NATO General Territory Information

1. **Armis Commercial Cloud:**
   NATO networks up to NATO Restricted can consume commercial cloud offerings. During initial conversations with any potential NATO client perform strong discovery to determine the network type in question.      If the network in question is NATO Restricted or below you can present/demo Armis Commercial Cloud.
